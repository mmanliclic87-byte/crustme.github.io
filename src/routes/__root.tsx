...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "A black-themed landing page for \"Crust Me\" pizza, featuring a dynamic header and enquiry form." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "A black-themed landing page for \"Crust Me\" pizza, featuring a dynamic header and enquiry form." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "A black-themed landing page for \"Crust Me\" pizza, featuring a dynamic header and enquiry form." },
